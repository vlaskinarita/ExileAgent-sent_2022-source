...
namespace Newtonsoft.Json.Bson
{
	internal sealed class BsonBinaryWriter
	{
		...
		private void WriteTokenInternal(BsonToken t)
		{
			...
			throw new ArgumentOutOfRangeException(BsonBinaryWriter.getString_0(107342652), BsonBinaryWriter.getString_0(107318460).FormatWith(CultureInfo.InvariantCulture, t.Type));
		}
		...
		{
			Strings.CreateGetStringDelegate(typeof(BsonBinaryWriter));
