...
namespace Newtonsoft.Json.Serialization
{
	public sealed class JsonArrayContract : JsonContainerContract
	{
		...
		{
			if (!this.HasParameterizedCreatorInternal && underlyingType.Name == JsonArrayContract.getString_1(107338619))
			{
		...
		{
			Strings.CreateGetStringDelegate(typeof(JsonArrayContract));
		}
