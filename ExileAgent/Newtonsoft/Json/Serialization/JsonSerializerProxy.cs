...
namespace Newtonsoft.Json.Serialization
{
	internal sealed class JsonSerializerProxy : JsonSerializer
	{
		...
		{
			ValidationUtils.ArgumentNotNull(serializerReader, JsonSerializerProxy.getString_1(107297463));
		...
		{
			ValidationUtils.ArgumentNotNull(serializerWriter, JsonSerializerProxy.getString_1(107297438));
		...
		{
			Strings.CreateGetStringDelegate(typeof(JsonSerializerProxy));
		}
