...
namespace Newtonsoft.Json.Utilities
{
	internal static class DateTimeUtils
	{
		...
		{
			Strings.CreateGetStringDelegate(typeof(DateTimeUtils));
		...
		public static XmlDateTimeSerializationMode ToSerializationMode(DateTimeKind kind)
		{
			...
			default:
				throw MiscellaneousUtils.CreateArgumentOutOfRangeException(DateTimeUtils.getString_0(107345022), kind, DateTimeUtils.getString_0(107345013));
			}
		}
		...
		internal static DateTime EnsureDateTime(DateTime value, DateTimeZoneHandling timeZone)
		{
			...
			case DateTimeZoneHandling.RoundtripKind:
				break;
			default:
				throw new ArgumentException(DateTimeUtils.getString_0(107344428));
			}
			return value;
		}
		...
		internal static bool TryParseDateTime(StringReference s, DateTimeZoneHandling dateTimeZoneHandling, string dateFormatString, CultureInfo culture, out DateTime dt)
		{
			if (s.Length > 0)
			{
				...
				if (s[startIndex] == '/')
				{
					if (s.Length >= 9 && s.StartsWith(DateTimeUtils.getString_0(107344415)) && s.EndsWith(DateTimeUtils.getString_0(107344406)) && DateTimeUtils.TryParseDateTimeMicrosoft(s, dateTimeZoneHandling, out dt))
					{
						return true;
					}
				}
		...
		internal static bool TryParseDateTime(string s, DateTimeZoneHandling dateTimeZoneHandling, string dateFormatString, CultureInfo culture, out DateTime dt)
		{
			if (s.Length > 0)
			{
				if (s[0] == '/')
				{
					if (s.Length >= 9 && s.StartsWith(DateTimeUtils.getString_0(107344415), StringComparison.Ordinal) && s.EndsWith(DateTimeUtils.getString_0(107344406), StringComparison.Ordinal) && DateTimeUtils.TryParseDateTimeMicrosoft(new StringReference(s.ToCharArray(), 0, s.Length), dateTimeZoneHandling, out dt))
					{
						return true;
					}
				}
				else if (s.Length >= 19 && s.Length <= 40 && char.IsDigit(s[0]) && s[10] == 'T' && DateTime.TryParseExact(s, DateTimeUtils.getString_0(107344369), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out dt))
				{
		...
		internal static bool TryParseDateTimeOffset(StringReference s, string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
		{
			if (s.Length > 0)
			{
				...
				if (s[startIndex] == '/')
				{
					if (s.Length >= 9 && s.StartsWith(DateTimeUtils.getString_0(107344415)) && s.EndsWith(DateTimeUtils.getString_0(107344406)) && DateTimeUtils.TryParseDateTimeOffsetMicrosoft(s, out dt))
					{
						return true;
					}
				}
		...
		internal static bool TryParseDateTimeOffset(string s, string dateFormatString, CultureInfo culture, out DateTimeOffset dt)
		{
			if (s.Length > 0)
			{
				if (s[0] == '/')
				{
					if (s.Length >= 9 && s.StartsWith(DateTimeUtils.getString_0(107344415), StringComparison.Ordinal) && s.EndsWith(DateTimeUtils.getString_0(107344406), StringComparison.Ordinal) && DateTimeUtils.TryParseDateTimeOffsetMicrosoft(new StringReference(s.ToCharArray(), 0, s.Length), out dt))
					{
						return true;
					}
				}
				else if (s.Length >= 19 && s.Length <= 40 && char.IsDigit(s[0]) && s[10] == 'T' && DateTimeOffset.TryParseExact(s, DateTimeUtils.getString_0(107344369), CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out dt) && DateTimeUtils.TryParseDateTimeOffsetIso(new StringReference(s.ToCharArray(), 0, s.Length), out dt))
				{
					return true;
				}
		...
		internal static int WriteDateTimeString(char[] chars, int start, DateTime value, TimeSpan? offset, DateTimeKind kind, DateFormatHandling format)
		{
			...
			if (format == DateFormatHandling.MicrosoftDateFormat)
			{
				...
				DateTimeUtils.getString_0(107344328).CopyTo(0, chars, start, 7);
				num2 = start + 7;
				...
				DateTimeUtils.getString_0(107344347).CopyTo(0, chars, num2, 3);
				num2 += 3;
			}
			else
			{
